...
## SCRIPT SETUP
Note: this will be improved with script finalisation! Hopefully in the form of a self-installing app using [Voila](https://github.com/voila-dashboards/voila).
