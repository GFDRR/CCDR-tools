...
<div class="risk-diagram">
  ...
  <div class="risk-container">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" preserveAspectRatio="xMidYMid meet">
      ...
      <!-- Exposure (Teal) -->
      <g class="risk-section" data-info="<h4>Exposure</h4><li>Location and value of assets<ul><li>People, property and systems location</li><li>Economic value of exposed assets</li></ul>">
      ...
      <g class="risk-section" data-info="<h4>Vulnerability</h4>Susceptibility of exposed elements to suffer damage<ul><li>Physical fragility<li>Socio-economic factors</li><li>Lack of resilience and coping capacity</li></ul>">
