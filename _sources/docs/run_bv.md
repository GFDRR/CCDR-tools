...
```{seealso}
See [**Risk and Poverty**](risk-poverty.md) for an explanation of the bivariate classification matrix, wealth index options, and how to interpret the 3×3 output scores.
```
