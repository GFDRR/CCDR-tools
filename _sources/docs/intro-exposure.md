...
In our tools, exposure datasets are collected in form of geospatial raster representing presence (1/0) or amount (count, density) for each category. There are of course alternative options for exposure representation, including polygons representing building-level footprints (perimeter, area), or lines representing distribution infrastructures.
