...
def main():
    ...
    haz_cat         = 'FL' 			  # Function analysis:'FL' for floods; 'CF' for coastal floods; 'TC' for tropical cyclones.
    ...
    min_haz_slider     = 0.05 			  # FL 0.05 # TC 25.0
    ...
    class_edges        = [0.05, 0.25, 0.50, 1.00, 2.00] # FL [0.05, 0.25, 0.50, 1.00, 2.00] # TC [17.0, 32.0, 42.0, 49.0, 58.0, 70.0]
